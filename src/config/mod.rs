...
pub use schema::{
    ...
    OutboundLeakGuardAction, OutboundLeakGuardConfig, PeripheralBoardConfig, PeripheralsConfig,
    PerplexityFilterConfig, PluginsConfig, ProjectIntelConfig, ProxyConfig, ProxyScope,
    ...
    TtsConfig, TunnelConfig, UrlAccessConfig, VerifiableIntentConfig, WebFetchConfig,
