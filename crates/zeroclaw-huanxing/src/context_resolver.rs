...
use zeroclaw_runtime::security::policy::SecurityPolicy;
...
pub struct MessageContext {
    ...
    pub knowledge_graph: Option<Arc<zeroclaw_memory::knowledge_graph::KnowledgeGraph>>,

    /// Multi-agent cross-workspace knowledge index.
    pub cross_knowledge_index:
        Option<Arc<crate::knowledge_cross::CrossWorkspaceKnowledgeIndex>>,
    ...
    pub multimodal: Option<zeroclaw_config::schema::MultimodalConfig>,
    ...
    pub reliability: Option<zeroclaw_config::schema::ReliabilityConfig>,
