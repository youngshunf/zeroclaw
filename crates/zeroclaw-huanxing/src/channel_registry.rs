...
-> &'static Mutex<Option<tokio::sync::mpsc::Sender<zeroclaw_api::channel::ChannelMessage>>> {
    static QUEUE: OnceLock<
        Mutex<Option<tokio::sync::mpsc::Sender<zeroclaw_api::channel::ChannelMessage>>>,
    > = OnceLock::new();
...
-> Option<tokio::sync::mpsc::Sender<zeroclaw_api::channel::ChannelMessage>> {
