...
pub async fn get_download_info(api_base: &str, resource_type: &str, resource_id: &str) -> Result<serde_json::Value> {
    let url = format!("{}/api/v1/marketplace/client/download/{}/{}", api_base, resource_type, resource_id);
